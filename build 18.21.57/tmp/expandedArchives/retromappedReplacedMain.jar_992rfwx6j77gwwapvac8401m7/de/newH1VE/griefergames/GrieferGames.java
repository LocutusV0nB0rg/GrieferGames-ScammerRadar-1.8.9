...
public class GrieferGames extends LabyModAddon {
    ...
    private boolean tabListUpdate = false;

    public boolean isTabListUpdate() {
        return tabListUpdate;
    }

    public void setTabListUpdate(boolean tabListUpdate) {
        this.tabListUpdate = tabListUpdate;
    }
    ...
    public void onEnable() {
        ...
        //final LocalDateTime deactivate = LocalDateTime.of(2020, 7, 4, 23, 59);
        ...
        getApi().registerForgeListener(new InputEvent.KeyInputEvent() {
            ...
            public void onKeyPress(InputEvent.KeyInputEvent event) {
                if (Keyboard.isKeyDown(Keyboard.KEY_TAB)) {
                    setTabListUpdate(true);
                    antiscammer.modifyTabList();
                    setTabListUpdate(false);
                }
